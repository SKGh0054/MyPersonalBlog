...
<template>
  <div class="tags-wrap" v-if="tagsStore.isShow">
    <el-tabs v-model="targetname" type="card" closable @tab-remove="closeTag" @tab-click="clickTag">
      <el-tab-pane v-for="tag in tagsStore.list" :label="tag.title" :key="tag.name" :name="tag.name">
      </el-tab-pane>
    </el-tabs>
